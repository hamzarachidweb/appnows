...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        try {
            ...
            $articleId = $db->insert('articles', $articleData);
            
            setFlashMessage('success', 'Article created successfully!');
            header('Location: articles.php');
            exit();
        } catch (Exception $e) {
            $errors[] = 'Failed to create article: ' . $e->getMessage();
...
<head>
    ...
    <title>Add New Article - Blog Admin</title>
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-lg-2 sidebar">
                <div class="p-3">
                    ...
                    <nav class="nav flex-column">
                        ...
                        <a class="nav-link active" href="add_article.php">
            ...
            <div class="col-md-9 col-lg-10">
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light mb-4">
                    <div class="container-fluid">
                        <span class="navbar-brand mb-0 h1">Add New Article</span>
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control content-editor" id="content" name="content" 
                                                  placeholder="Write your article content here..." required><?php echo sanitize($_POST['content'] ?? ''); ?></textarea>
                                    </div>
                                </div>
    ...
    <script>
                ...
                reader.onload = function(e) {
                    previewContainer.innerHTML = `
                        ...
                        <p class="text-success mt-2 mb-0">
                            <i class="fas fa-check-circle"></i> Image selected: ${input.files[0].name}
                        </p>
        ...
        document.querySelector('form').addEventListener('submit', function(e) {
            ...
            Swal.fire({
                ...
                text: 'Please wait while we create your article.',
